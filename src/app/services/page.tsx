...
const servicesSchema = {
  ...
  '@id': 'https://www.royaluniondesign.com/services#services',
  ...
  'hasOfferCatalog': {
    ...
    'itemListElement': [
      { '@type': 'Offer', 'itemOffered': { '@type': 'Service', 'name': 'Rótulos Luminosos', 'url': 'https://www.royaluniondesign.com/rotulos' } },
      ...
      { '@type': 'Offer', 'itemOffered': { '@type': 'Service', 'name': 'Branding e Identidad Visual', 'url': 'https://www.royaluniondesign.com/services#branding' } },
      { '@type': 'Offer', 'itemOffered': { '@type': 'Service', 'name': 'Diseño Web Barcelona', 'url': 'https://www.royaluniondesign.com/services#web' } },
      { '@type': 'Offer', 'itemOffered': { '@type': 'Service', 'name': 'E-commerce Shopify Barcelona', 'url': 'https://www.royaluniondesign.com/services#ecommerce' } },
    ],
  },
}
...
export default function Services() {
  return (
    <main style={{ background: 'var(--bg)' }}>
      ...
      <Navbar light />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema(BREADCRUMBS.services())) }} />
      {/* ── HERO ──────────────────────────────────────────── */}
      <section style={{
