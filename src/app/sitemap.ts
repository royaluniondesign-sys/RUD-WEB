...
export default function sitemap(): MetadataRoute.Sitemap {
  const core: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/pricing`,  lastModified: d('2026-07-06'), changeFrequency: 'monthly', priority: 0.88 },
    { url: `${BASE}/services`, lastModified: d('2026-07-06'), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${BASE}/blog`,     lastModified: d('2026-07-06'), changeFrequency: 'weekly',  priority: 0.80 },
    { url: `${BASE}/work`,     lastModified: d('2026-07-06'), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${BASE}/about`,    lastModified: d('2026-07-06'), changeFrequency: 'monthly', priority: 0.70 },
  ...
  const coreServiceSlugs: Array<{ slug: string; lastMod: string }> = [
    { slug: 'neon-led-barcelona',          lastMod: '2026-07-06' },
    { slug: 'letras-corporeas-barcelona',  lastMod: '2026-07-06' },
    { slug: 'cajas-de-luz-barcelona',      lastMod: '2026-07-06' },
    { slug: 'vinilos-escaparate-barcelona',lastMod: '2026-07-06' },
    { slug: 'senaletica-interior-barcelona',lastMod: '2026-07-06' },
    { slug: 'publicidad-exterior-barcelona',lastMod: '2026-07-06' },
  ]
  ...
  const blogEntries: Array<{ slug: string; lastMod: string; priority: number }> = [
    ...
    { slug: 'branding-ecommerce-shopify-barcelona',                             lastMod: '2026-07-06', priority: 0.65 },
    { slug: 'identidad-visual-vs-logo-diferencia',                              lastMod: '2026-07-06', priority: 0.65 },
    { slug: 'estrategia-marca-startups-barcelona',                              lastMod: '2026-07-06', priority: 0.65 },
    { slug: 'nextjs-vs-wordpress-2026',                                         lastMod: '2026-07-06', priority: 0.65 },
    // IA / automation — lower priority for rótulos business
    { slug: 'ia-local-vs-nube-agencias-creativas',                              lastMod: '2026-07-06', priority: 0.55 },
    { slug: 'aura-el-agente-ia-autonomo-que-lidera-la-operacion-de-rud-st',     lastMod: '2026-07-06', priority: 0.55 },
    { slug: 'automatizacion-marketing-agencias-n8n',                            lastMod: '2026-07-06', priority: 0.55 },
  ]
  ...
  const workEntries: Array<{ slug: string; lastMod: string }> = [
    { slug: 'sante',   lastMod: '2026-07-06' },
    { slug: 'novae',   lastMod: '2026-07-06' },
    { slug: 'lumina',  lastMod: '2026-07-06' },
    { slug: 'idnt',    lastMod: '2026-07-06' },
    { slug: 'kopess',  lastMod: '2026-07-06' },
    { slug: 'oxyzen',  lastMod: '2026-07-06' },
    { slug: 'aurum',   lastMod: '2026-07-06' },
  ]
