...
export default function RotulosHospitalet() {
  ...
  return (
    <main style={{ background: 'var(--bg)' }}>
      ...
      <Navbar light />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema(BREADCRUMBS.rotulosGeo('hospitalet-de-llobregat', "L'Hospitalet"))) }} />
      {/* HERO */}
