...
export default function WhatsAppButton() {
  ...
  return (
    <a
      href="https://wa.me/34645593227?text=Hola%2C%20me%20interesa%20vuestro%20trabajo.%20%C2%BFPod%C3%A9is%20darme%20informaci%C3%B3n%3F"
      target="_blank"
      ...
      style={{
        ...
        textDecoration: 'none',
        transition: 'transform .2s ease, opacity .4s ease, box-shadow .2s ease',
        opacity: visible ? 1 : 0,
